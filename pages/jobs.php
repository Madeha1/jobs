...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="jobs.php">
        Our<span>Jobs</span>
        </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a class="nav-link" href="jobs.php"><i class="fa fa-home" aria-hidden="true"></i>Home</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="jobs.php"><i class="fa fa-users" aria-hidden="true"></i>About Us</a>
        </li>
        </ul>
        <!-- <div>
...
foreach ($jobs as $row){
    ...
    if($row['sponsored'] == 1){ 
        ?>
        <div class="card col-3 m-2 pt-2 shadow">
            <img class="card-img-top" src="<?php $row['image']?>">          
              <div class="card-body">
